...
# --- Cena 2: 🎬 CENA 2 — 1. Framework OWASP LLM Top 10 (2026) (Duração: 15s) ---
echo "🎤 Gerando TTS cena 2..."
gcloud text-to-speech synthesize \
    --text="[Narração da cena 2: 🎬 CENA 2 — 1. Framework OWASP LLM Top 10 (2026) (Duração: 15s)]" \
    --voice="$VOICE" \
    --speed="$SPEED" \
    --pitch="$PITCH" \
...
# --- Cena 3: 🎬 CENA 3 — 2. Vetor 1-5: Prompt Injection (Duração: 15s) ---
echo "🎤 Gerando TTS cena 3..."
gcloud text-to-speech synthesize \
    --text="[Narração da cena 3: 🎬 CENA 3 — 2. Vetor 1-5: Prompt Injection (Duração: 15s)]" \
    --voice="$VOICE" \
    --speed="$SPEED" \
    --pitch="$PITCH" \
...
# --- Cena 4: 🎬 CENA 4 — Vetor 1 — Direct Prompt Injection (DPI) (Duração: 15s) ---
echo "🎤 Gerando TTS cena 4..."
gcloud text-to-speech synthesize \
    --text="[Narração da cena 4: 🎬 CENA 4 — Vetor 1 — Direct Prompt Injection (DPI) (Duração: 15s)]" \
    --voice="$VOICE" \
    --speed="$SPEED" \
    --pitch="$PITCH" \
