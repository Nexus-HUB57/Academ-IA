...
# --- Cena 2: 🎬 CENA 2 — 1. Anchor (âncora) (Duração: 15s) ---
echo "🎤 Gerando TTS cena 2..."
gcloud text-to-speech synthesize \
    --text="[Narração da cena 2: 🎬 CENA 2 — 1. Anchor (âncora) (Duração: 15s)]" \
    --voice="$VOICE" \
    --speed="$SPEED" \
    --pitch="$PITCH" \
...
# --- Cena 3: 🎬 CENA 3 — 2. Charm pricing (R$ 97 vs R$ 100) (Duração: 15s) ---
echo "🎤 Gerando TTS cena 3..."
gcloud text-to-speech synthesize \
    --text="[Narração da cena 3: 🎬 CENA 3 — 2. Charm pricing (R\$ 97 vs R\$ 100) (Duração: 15s)]" \
    --voice="$VOICE" \
    --speed="$SPEED" \
    --pitch="$PITCH" \
...
# --- Cena 4: 🎬 CENA 4 — 3. Decoy effect (efeito isca) (Duração: 15s) ---
echo "🎤 Gerando TTS cena 4..."
gcloud text-to-speech synthesize \
    --text="[Narração da cena 4: 🎬 CENA 4 — 3. Decoy effect (efeito isca) (Duração: 15s)]" \
    --voice="$VOICE" \
    --speed="$SPEED" \
    --pitch="$PITCH" \
