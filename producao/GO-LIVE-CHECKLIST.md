...
date: 2026-07-21
horizonte: "Onda 40 (v1.4.0) · contínuo"
status: ativo · v1.4.0
---

# 🚀 Go-Live Checklist · AcademIA

> Plano operacional da AcademIA na Onda 40 (v1.4.0). Tudo que precisa ser verificado,
> validado, publicado e sincronizado no novo repo `Nexus-HUB57/Academ-IA`.

## 🎯 Objetivo

Operar a AcademIA com:
- ✅ **3 módulos** publicados (piloto, Onda 39) — `00-boas-vindas`, `01-ioaid`, `02-sho`
- ✅ **11 módulos** com roteiro pronto aguardando render (Agente 1-4, Master 1-4, Elite 1-3)
- ✅ **5 roteiros-âncora TECH** (15-19) com thumbnails 2K — novos da Onda 40
...
- ✅ Smoke test passando
- ✅ **Migração para repo dedicado `Nexus-HUB57/Academ-IA` concluída**
