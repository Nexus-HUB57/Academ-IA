...
- **01 · Entendendo o IOAID** — vídeo: `video-01-ioaid.mp4` · thumb: `01-entendendo-o-ioaid.png`
- **02 · O Sistema SHO (Self-Healing Orchestrator)** — vídeo: `video-02-sho.mp4` · thumb: `02-o-sistema-sho-self-healing-orchestrator.png`
- **03 · Painel do Afiliado — Visão Geral da Operação** — vídeo: `video-03-painel.mp4` · thumb: `03-painel-do-afiliado-visao-geral-da-operacao.png`
- **04 · Construindo Seu Primeiro Agente em 4 Minutos** — vídeo: `mod00-primeiro-agente.mp4` · thumb: `04-construindo-seu-primeiro-agente-em-4-minutos.png`
- **05 · Skills Essenciais — Copywriter + Audience-Segmenter** — vídeo: `mod01-skills-essenciais.mp4` · thumb: `05-skills-essenciais-copywriter-audience-segmenter.png`
- **06 · Disparando no WhatsApp em Escala** — vídeo: `mod02-disparo-whatsapp.mp4` · thumb: `06-disparando-no-whatsapp-em-escala.png`
- **07 · Judge Revisor — A IA que Decide por Você** — vídeo: `mod03-judge-revisor.mp4` · thumb: `07-judge-revisor-a-ia-que-decide-por-voce.png`
