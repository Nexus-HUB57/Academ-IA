#!/bin/bash
# =============================================================================
# RENDERIZAÇÃO — Aula 30: Federação Zero-Trust — Segurança Avançada para Agentes A2A
# Trilha: Elite | Persona: Alencar | Cenas: 6
# =============================================================================

set -euo pipefail

AULA="30"
SLUG="federação-zero-trust-—-segurança-avançad"
TRILHA="Elite"
PERSONA="Alencar"
TOTAL_CENAS=6
